...
class Auth extends Component {
  ...
  inputChangedHandler = (event, controlName) => {
    const resultValidity = this.checkValidity(event.target.value, this.state.controls[controlName].validation);
    const updatedControls = {
      ...this.state.controls,
      [controlName]: {
        ...this.state.controls[controlName],
        value: event.target.value,
        valid: resultValidity.isValid,
        errorMessage: resultValidity.errorMessage,
        touched: true
      }
    }
